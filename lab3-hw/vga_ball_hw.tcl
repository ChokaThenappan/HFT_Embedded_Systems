...
add_interface_port avalon_slave_0 write write Input 8
...
add_interface_port avalon_slave_0 VGA_CLK readdata Output 8
add_interface_port avalon_slave_0 VGA_HS readdata Output 8
add_interface_port avalon_slave_0 VGA_VS response Output 1
add_interface_port avalon_slave_0 VGA_BLANK_n readdata Output 8
add_interface_port avalon_slave_0 VGA_SYNC_n response Output 1
